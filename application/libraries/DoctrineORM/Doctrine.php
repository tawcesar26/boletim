...
// Set up class loading. You could use different autoloaders, provided by your favorite framework,
 // if you want to.
 require_once APPPATH . '/DoctrineORM/Doctrine/Common/ClassLoader.php';
 require_once APPPATH . "/DoctrineORM/Doctrine/ORM/Tools/Setup.php";
Doctrine\ORM\Tools\Setup::registerAutoloadDirectory(APPPATH . "libraries/DoctrineORM");
$doctrineClassLoader = new ClassLoader('Doctrine', APPPATH . 'libraries/DoctrineORM');
